...
class RegisterController extends GetxController {
  ...
  bool isValidForm(
    ...
    if (phone.isEmpty) {
      Get.snackbar('Formulario no valido', 'Debes ingresar su numero');
      return false;
    }
    ...
    if (confirmPassword.isEmpty) {
      Get.snackbar('Formulario no valido', 'Digite nuevamente el password');
      return false;
    }

    if (password != confirmPassword) {
      Get.snackbar('Formulario no valido', 'Contraseñas no coinciden');
      return false;
    }
