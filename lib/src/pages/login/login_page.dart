import 'package:eatfoot_flutter_delivery/src/pages/login/login_controller.dart';
    ...
    return Scaffold(
      ...
      body: Stack( // POSICIONA ELEMENTOS UNO ENCIMA DEL OTRO
        children: [
          ...
          _boxForm(context),
          Column( // POSICIONA ELEMENTOS UNOP DEBAJO DEL OTRO(VERTICAL)
            children: [
              _imageCover(),
              _textAappName()
            ],
